...
const Footer: React.FC = () => {
  ...
  const services = [
    { name: 'Online Consultations', href: '/consultation' },
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mb-4 text-gray-400 leading-relaxed">
              Providing accessible online healthcare through secure telemedicine services. 
              Connect with certified doctors virtually, anytime, anywhere.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <span>Online Platform - Accessible Worldwide</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg
                  className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1"
              ...
              <li className="flex items-start space-x-3">
                ...
                <span>info@eugeneonlinehealth.com</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg
                  className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {currentYear} Eugene Online Health Center. All rights reserved.
            </p>
